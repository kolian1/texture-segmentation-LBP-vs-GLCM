...
%
%% Description
% This functions wraps Matlab figure function, allowing the user to set the figure size to
% one of the two following states- full screen or non full screen (figure default). As
% figure function results with non-maximized dimensions, the default in this function if
...
%  All Figure Properties acceptable by figure function are supported by this function as
%  well.
...
%
%% Revision history
% First version: Nikolay Skarbnik 2011-06-07.
% Last update:   Nikolay Skarbnik 2011-06-07.
%
% *List of Changes:*
